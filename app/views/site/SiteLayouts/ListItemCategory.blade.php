<div class="col-left-92">
	<div class="head-info">
		<h2>
			<a href="">@if(isset($arrCategory[$category_id]['category_icons']))<i class="{{$arrCategory[$category_id]['category_icons']}}"></i>@endif
		...
		<div class="like-social pull-right">
			<div class="fb">
				...
				<div class="fb-like" data-href="{{FunctionLib::buildLinkCategory($arrCategory[$category_id]['category_id'], $arrCategory[$category_id]['category_name'])}}"
