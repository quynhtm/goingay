...
<div class="inner-box">
	...
	<div class="page-content-box">
		...
		@endif
		{{Form::open(array('method' => 'POST', 'id'=>'formListItem', 'class'=>'formListItem', 'name'=>'txtForm', 'url'=>URL::route('admin.trash_delete')))}}
				...
				<table width="100%" cellspacing="1" cellpadding="5" border="1">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{URL::route('admin.trash_edit')}}/{{$item['trash_id']}}" title="Cập nhật">
