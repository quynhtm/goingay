...
class Provice extends Eloquent{
    
    protected $table = 'web_provice';
    protected $primaryKey = 'provice_id';
    public  $timestamps = false;
    protected $fillable = array(
	    	'provice_id', 'provice_title','provice_order_no', 'provice_created', 'provice_status',
    );
    //ADMIN
    ...
    public static function saveData($id=0, $data=array()){
  	...
  	public static function removeCacheId($id=0){
  		if($id>0){
  			...
  			Cache::forget(Memcache::CACHE_PROVICE_ID);
  		}
  	}
