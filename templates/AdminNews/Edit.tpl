        ...
        <div class="col-sm-12">
            <div class="form_bound">
                 <table cellpadding="4" width="100%" bgcolor="#D3E1F1">
                    <tr>
                        <td width="70%" align="center" class="save-form-title"><h2 class="title_form">{$mode} một tin bài</h2></td>
                        <td width="10%" class="form_title_button">
                            <a class="icons_controll" href="javascript:void(0);" onclick="Common_admin.checkFormEdit(1,1);"><span alt="save" class="icon_save_tem" ></span>Lưu tạm</a>
                        </td>
                        <td width="10%" class="form_title_button">
